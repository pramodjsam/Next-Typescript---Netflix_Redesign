  ...
  return (
    <div className="h-40 space-y-0.5 md:space-y-2">
      ...
      <div className="group relative md:-ml-2">
        ...
        left-2 z-40 h-9 w-9 m-auto cursor-pointer transition
        hover:scale-125 opacity-0 group-hover:opacity-100 ${
          !isMoved && "hidden"
        }`}
        ...
        <ChevronRightIcon
          className={`absolute top-0 bottom-0
        right-2 z-60 h-9 w-9 m-auto cursor-pointer transition
        hover:scale-125 opacity-0 group-hover:opacity-100`}
